...
RegisterCommand("10-13", function()
	ESX.TriggerServerCallback('10-13:checkjob', function(ils1)
		if ils1 == true then
				local Officer = {}
				...
				TriggerServerEvent("10-13:request", Officer)
		else
...
RegisterNetEvent("10-13:alert")
AddEventHandler("10-13:alert", function(source, Officer)
	if ESX.GetPlayerData().job.name == 'police' then
		...
		TriggerEvent('chat:addMessage', {
			...
			args = { '^*^7[Powiadomienie]: ^810-13 ^7- Ranny Funkcjonariusz | ^3na ulicy ^7' .. Officer.Location }
		  })
		Citizen.CreateThread(function()
