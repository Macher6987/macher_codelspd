...
RegisterCommand("10-38", function()
	ESX.TriggerServerCallback('10-38:checkjob', function(ils1)
		if ils1 == true then
				...
				TriggerServerEvent("10-38:request", Officer)
		else
...
RegisterNetEvent("10-38:alert")
AddEventHandler("10-38:alert", function(source, Officer)
	if ESX.GetPlayerData().job.name == 'police' then
		PlaySoundFrontend(-1, "HACKING_CLICK_GOOD", 0, 1)
		TriggerEvent('chat:addMessage', {
			template = '<div style="padding: 0.5vw; margin: 0.5vw; background-color: rgba(114, 114, 114, 0.5); border-radius: 3px; margin-left: 0; margin-right: 0;">^*{0}  </div>',
			args = { '^*^7[Powiadomienie]: ^810-38 ^7- Funkcjonarjusz przeprowadza zatrzymanie | ^3na ulicy ^7' .. Officer.Location }
		  })
		Citizen.CreateThread(function()
